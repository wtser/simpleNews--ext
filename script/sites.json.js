module.exports = [
  ...
  {
    icon:
      "http://rs-assets.b0.upaiyun.com/assets/apple-touch-icon-180x180-precomposed-763d5ea2ad5193d98490fa9b7c362cfc.png",
    name: "NEXT",
  ...
  {
    icon:
      "http://wanqu.co/static/images/wanqu/favicons/apple-touch-icon-180x180.png",
  ...
  {
    icon:
      "http://sfault-avatar.b0.upaiyun.com/235/056/2350560982-56796cae3be72_huge256",
  ...
  },
  {
    type: "ajax",
    api:
      "https://hstar-hi.alicdn.com/dream/ajax/getProjectList.htm?page=1&pageSize=30&projectType=&type=6&status=1&sort=1",
  ...
  {
    icon:
      "http://static.360buyimg.com/finance/base/1.2.0/images/logo-slogan.png",
    url:
      "http://z.jd.com/bigger/search.html?status=2&sort=zhtj&categoryId=&parentCategoryId=&sceneEnd=&productEnd=&keyword=&page=1&pageSize=30",
    name: "京东众筹",
    type: "html",
